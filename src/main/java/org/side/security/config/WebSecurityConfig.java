...
import org.side.CustomCorsFilter;
import org.side.security.RestAuthenticationEntryPoint;
import org.side.security.auth.ajax.AjaxAuthenticationProvider;
import org.side.security.auth.ajax.AjaxLoginProcessingFilter;
import org.side.security.auth.jwt.JwtAuthenticationProvider;
import org.side.security.auth.jwt.JwtTokenAuthenticationProcessingFilter;
import org.side.security.auth.jwt.SkipPathRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public static final String AUTHENTICATI_URL = "/users";
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable() // We don't need CSRF for JWT based authentication
				...
				.authorizeRequests().antMatchers(API_ROOT_URL).authenticated() // Protected
																				// API
																				// End-points
